    ...
    <div class="col-lg-8 align-content" style="margin-left: auto;margin-right: auto">
        <div class="card section-center">
            <div class="card-body">
                ...
                <h5 class="card-title">
                    <div class="text-center">{{ isset($wishlist) ? 'Edit Wishlist' : 'Create Wishlist' }}</div>
                </h5>

                <!-- General Form Elements -->
                <form action="{{ isset($wishlist) ? '/wishlist/update/' . $wishlist->id : '/wishlist/insert' }}" method="POST"
