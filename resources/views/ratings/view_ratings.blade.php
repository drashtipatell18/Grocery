        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('create.rating') }}"><button type="button" class="btn btn-gradient-info btn-sm"><i
                                class="bi bi-plus-lg me-1"></i>Add Rating</button></a>
                </div>
                    ...
                    <tbody>
                        @foreach ($ratings as $index => $rating)
                            <tr class="">
                                ...
                                <td class="text-center">{{ $rating->product->name }}</td>
                                <td class="text-center">{{ $rating->customer_name }}</td>
                                <td class="text-center">{{ $rating->star }}</td>
                                <td class="text-center">{{ $rating->review }}</td>
                                <td class="text-center">
                                    <a href="{{ route('edit.rating', $rating->id) }}"
                                        class="btn btn-gradient-success btn-sm"><i class="bi bi-pencil-square"></i></a>
                                    <a href="{{ route('destroy.rating', $rating->id) }}"
