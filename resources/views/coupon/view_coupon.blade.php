        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('create.coupon') }}"><button type="button" class="btn btn-gradient-info btn-sm"><i
                                class="bi bi-plus-lg me-1"></i>Add Coupon</button></a>
                </div>
                        ...
                        @foreach ($coupons as $index => $coupon)
                            <tr class="">
                                ...
                                <td class="text-center">
                                    @if ($coupon->image)
                                        <img src="{{ asset('images/' . $coupon->image) }}" alt="User Image" 
                                            height="50px">
                                    @else
                                        No Photo Available
                                    @endif
                                ...
                                <td class="text-center">
                                    ...
                                    <a href="{{ route('destroy.coupon', $coupon->id) }}"
